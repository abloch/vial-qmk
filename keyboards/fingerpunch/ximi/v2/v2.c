...
//COL   00     01      02       03      04      05      06      07        ROW
    {  18,     17,     12,      11,      6,      5,      2,    NO_LED },//00
    {  19,     16,     13,      10,      7,      4,      1,    NO_LED },//01
    {  20,     15,     14,       9,      8,      3,      0,    NO_LED },//02
    { NO_LED, NO_LED, NO_LED, NO_LED, NO_LED, NO_LED, NO_LED, NO_LED },//03
    {  39,     38,     33,      32,     27,     26,     23,    NO_LED },//00
    {  40,     37,     34,      31,     28,     25,     22,    NO_LED },//01
    {  41,     36,     35,      30,     29,     24,     21,    NO_LED },//02
    { NO_LED, NO_LED, NO_LED, NO_LED, NO_LED, NO_LED, NO_LED, NO_LED },//03
}, {
    // Left
    {93	, 63}, // Thumb reachy
